...
public class ViewDecentralizeForm extends JDialog {
    ...
    public ViewDecentralizeForm(NhomQuyenBUS buss,DecentralizeView jpPhanQuyen, NhomQuyen nhomQuyen) {
    ...
    public void initView() {
        ...
        this.txtTennhomquyen.setEnabled(false);
