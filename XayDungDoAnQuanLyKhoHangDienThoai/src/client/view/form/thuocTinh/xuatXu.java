...
public class xuatXu extends JDialog {
    ...
    public xuatXu() {
        ...
        // ===== Title =====
        JLabel lblTitle = new JLabel("XUẤT XỨ", SwingConstants.CENTER);
        ...
        JLabel lbl = new JLabel("Tên xuất xứ ");
        ...
        // ===== Table =====
        String[] columnNames = {"Mã xuất xứ", "Tên xuất xứ"};
        Object[][] data = {
    ...
    public void loadXuatXu() {
        ...
        List<XuatXu> list = dao.getAllXuatXu();
