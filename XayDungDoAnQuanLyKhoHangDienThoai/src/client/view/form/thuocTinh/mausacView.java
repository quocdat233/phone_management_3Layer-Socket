...
public class mausacView extends JDialog {
    ...
    public mausacView() {
        ...
        // ===== Title =====
        JLabel lblTitle = new JLabel("MÀU SẮC", SwingConstants.CENTER);
        ...
        JLabel lbl = new JLabel("Tên màu sắc ");
        ...
        // ===== Table =====
        String[] columnNames = {"Mã MÀU", "Tên MÀU"};
        Object[][] data = {
    ...
    public void loadMauSac() {
        ...
        List<mausac> list = dao.getMausac();
