...
public class romView extends JDialog {
    ...
    public romView() {
        ...
        // ===== Title =====
        JLabel lblTitle = new JLabel("DUNG LƯỢNG ROM", SwingConstants.CENTER);
        ...
        // ===== Table =====
        String[] columnNames = {"Mã ROM", "Tên ROM"};
        Object[][] data = {
