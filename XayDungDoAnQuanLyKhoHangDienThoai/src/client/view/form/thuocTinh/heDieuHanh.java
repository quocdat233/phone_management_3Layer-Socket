...
public class heDieuHanh extends JDialog {
    ...
    public heDieuHanh() {
        ...
        // ===== Title =====
        JLabel lblTitle = new JLabel("HỆ ĐIỀU HÀNH", SwingConstants.CENTER);
        ...
        JLabel lbl = new JLabel("Hệ điều hành ");
        ...
        // ===== Table =====
        String[] columnNames = {"Mã HDH", "Tên HDH"};
        Object[][] data = {
    ...
    public void loadHDH() {
        ...
        List<HeDieuHanh> list = dao.getAllHeDieuHanh();
