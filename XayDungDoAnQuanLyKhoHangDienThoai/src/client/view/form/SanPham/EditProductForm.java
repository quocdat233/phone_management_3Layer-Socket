...
public class EditProductForm extends JDialog {
    ...
    private JTextField txtVersion, txtWarranty, txtColor, txtImportPrice, txtExportPrice;
    private JLabel lblImagePreview;
    private JPanel panelTop, panelBottom;
    private JPanel panelContainer, panelImage, panelContent;
    private JButton btnSave, btnCancel,btnUp;
    ...
    private JComboBox<String> txtROM;
    private JComboBox<String> txtRAM;
    private JTextField txtHdh;
    ...
    public EditProductForm() {
        ...
        // Sửa lỗi chính tả "Khu vưc" → "Khu vực"
        ...
        // button chỉnh sửa
        btnUp = new JButton("Sửa cấu hình");
        btnUp.setBorderPainted(false);
        btnUp.setFont(new Font("Arial", Font.BOLD, 14));
        btnUp.setPreferredSize(new Dimension(150, 40));
        btnUp.setBackground(Color.decode("#ECA300"));
        ...
        btnCancel.setBackground(Color.decode("#C54F55"));
    ...
    public void sanPhamEdit(SanPham sp) {

        if (sp != null) {
            System.out.println("Có dữ liệu");

            String chip = String.valueOf(sp.getChip());
            String dungLuongPin = String.valueOf(sp.getDungLuongPin());
            String kichThuocMan = String.valueOf(sp.getKichThuocMan());
            String camTruoc = String.valueOf(sp.getCamTruoc());
            String camSau = String.valueOf(sp.getCamSau());
            ...
            txtRearCamera.setText(camSau);
            txtFrontCamera.setText(camTruoc);
    ...
    public JComboBox getTxtOrigin() {
        return txtOrigin;
    }

    public void setTxtOrigin(JComboBox txtOrigin) {
        this.txtOrigin = txtOrigin;
    }

    public JComboBox getTxtOS() {
        return txtOS;
    }

    public void setTxtOS(JComboBox txtOS) {
        this.txtOS = txtOS;
    }

    public JComboBox getTxtBrand() {
        return txtBrand;
    }

    public void setTxtBrand(JComboBox txtBrand) {
        this.txtBrand = txtBrand;
    }

    public JComboBox getTxtWarehouse() {
        return txtWarehouse;
    }

    public void setTxtWarehouse(JComboBox txtWarehouse) {
