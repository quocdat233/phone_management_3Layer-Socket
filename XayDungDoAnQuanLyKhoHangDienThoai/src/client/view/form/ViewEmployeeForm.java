...
public class ViewEmployeeForm extends JDialog {
    ...
    public ViewEmployeeForm() {
        ...
        JLabel lblTitle = new JLabel("XEM NHÂN VIÊN");
...
//        dateChooser.setPreferredSize(new Dimension(200, 30));
    ...
    public void setEmployeeData(String ten, int gioiTinh, Date ngaySinh, String sdt, String email) {
        ...
        dateChooser.setEnabled(false); // Khóa chỉnh sửa ngày sinh

        // Khóa chỉnh sửa các trường văn bản
        txtEmployeeName.setEnabled(false);
//        txtEmployeeName.setBackground(Color.decode("#C3C3C3"));

        txtEmployeeEmail.setEnabled(false);
//        txtEmployeeEmail.setBackground(Color.decode("#C3C3C3"));

        txtEmployeePhone.setEnabled(false);
//        txtEmployeePhone.setBackground(Color.decode("#C3C3C3"));
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            new ViewEmployeeForm().setVisible(true);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
