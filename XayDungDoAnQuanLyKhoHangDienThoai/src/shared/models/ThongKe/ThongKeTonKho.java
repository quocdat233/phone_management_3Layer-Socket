...
public class ThongKeTonKho {
    ...
    public ThongKeTonKho(int masp, int maphienbansp, String tensanpham, int ram, int rom, String mausac, int tondauky, int nhaptrongky, int xuattrongky, int toncuoiky) {
        this.masp = masp;
    ...
    public boolean equals(Object obj) {
        ...
        final ThongKeTonKho other = (ThongKeTonKho) obj;
